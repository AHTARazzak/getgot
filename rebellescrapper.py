    ...
    def test_sel(self):
        ...
        for itemurl in itemlinks:
            ...
            if not os.path.exists(folderpath+"rebelle_"+itemcode):
                ...
                append_list_as_row(folderpath+self.directoryname+"catalogue.csv",["rebelle",self.directoryname, itemcode, base_url,theprice,"N/A","N/A","N/A",thematerial,thecolour,thesize,"N/A","N/A",thecondition,datetime.datetime.now()])
